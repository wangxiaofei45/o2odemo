...
<template>
	<div class="tab-container">
		<div class="title">
			<el-row>
				<el-col :span="24">
					<el-button v-show="permission.indexOf('111') != -1" style="margin-right: 20px;" type="primary" @click="addMember">
						<svg-icon icon-class="add" style="margin-right: 10px;" /> <span>新增</span>
					</el-button>
					<el-input placeholder="输入供应商/手机号" style="width:300px" v-model="searchVal">
						<template slot="append">
							<el-button @click='ajaxjson' style="background-color: #e0e0e0;border-radius: 0px;">
			...
			<el-table :data="data" stripe border style="width: 100%;" size="mini" @selection-change="SelectionChange">
				...
				<el-table-column label="操作" width="300" fixed="right" align="center">
					<template slot-scope="scope">
						<el-button v-show="permission.indexOf('112') != -1" size="mini" type="primary" @click="amendMember(scope.row)">编辑</el-button>
						<el-button v-show="permission.indexOf('113') != -1" size="mini" type="danger" @click="deletes(scope.row.id)">删除</el-button>
					</template>
				</el-table-column>
			</el-table>
			...
			<div class="model_con">
				...
				<el-form :model="form" :rules="form_rule" ref="form" label-width="100px">
					<el-row>
						...
						<el-col :span="12">
							<el-form-item label="手机号" prop="contacts_tel">
						...
						<el-col :span="12">
							<el-form-item label="进货折扣" prop="discounts">
								<el-input-number style="width: 200px;" v-model="form.discounts" :step="0.01" controls-position="right" :min="0" :max="1"></el-input-number>
							</el-form-item>
						</el-col>
						<el-col :span="12">
					...
					<el-row style="text-align: center;" class="bottomButton">
						...
						<el-button type="primary" @click="submitForm('form')" align="center">保存</el-button>
					</el-row>
				</el-form>
			</div>
		</div>
			...
			<div class="model_con">
				...
				<el-form :model="amendForm" :rules="amendFormRule" ref="amendForm" label-width="100px">
					<el-row>
						...
						<el-col :span="12">
							<el-form-item label="进货折扣" prop="discounts">
								<el-input-number v-model="amendForm.discounts" :precision="2" :step="0.01" controls-position="right" :min="0" :max="1"></el-input-number>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="开户银行" prop="bankname">
...
<script>
	export default {
		...
		methods: {
			...
			submitForm(formName) {
				this.$refs[formName].validate((valid) => {
					if(valid) {
						...
						postData.discounts = postData.discounts*100;
			...
			amendMember(e) {
				this.amendForm = e;
				this.amendForm.discounts = this.amendForm.discounts/100;
			...
			submitAmendForm(formName) {
				this.$refs[formName].validate((valid) => {
					if(valid) {
						...
						postData.discounts = Number(postData.discounts)*100;
...
<style scoped>
	...
	.model .model_con .el-input-group__append {

...
<template>
	<div class="tab-container">
		<div class="title">
			<el-row>
				<el-col :span="12">
					<el-button type="primary" @click="open_newInfo">添加角色</el-button>
				</el-col>
		...
		<el-table :data="data" stripe border style="width: 100%;" size="mini" @selection-change="SelectionChange">
			...
			<el-table-column prop="role_name" width="100"  label="角色名称" align="center">
			</el-table-column>
			<el-table-column prop="remark" label="备注名称" align="center">
			</el-table-column>
			<el-table-column label="操作" width="200" align="center">
				<template slot-scope="scope">
					<el-button size="mini" type="primary" icon="el-icon-edit" @click="amend(scope.row)">编辑</el-button>
		...
		<div class="model" v-show="new_info_model">
			<div class="model_con">
				...
				<el-form :model="new_info" ref="new_info" :rules="new_inforules" label-width="80px">
					<el-row>
						<el-col :span="24">
							<el-form-item label="手机号" prop="role_name">
								<el-input v-model="new_info.role_name"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item label="描述" prop="remark">
								<el-input v-model="new_info.remark"></el-input>
							</el-form-item>
						</el-col>
					</el-row>
					<el-row>
		...
		<!-- 新增角色 -->
		<div class="model" v-show="isAmend">
			<div class="model_con">
				<el-row class="model_title">
					<el-col :span="12" style="border-left: #13C2C2 3px solid; padding-left: 15px;">
						新增角色
			...
			<div class="model_con">
				...
				<el-form :model="amend_info" ref="amend_info" :rules="new_inforules" label-width="80px">
					<el-row>
						<el-col :span="24">
							<el-form-item label="手机号" prop="role_name">
								<el-input v-model="amend_info.role_name"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item label="描述" prop="remark">
								<el-input v-model="amend_info.remark"></el-input>
							</el-form-item>
						</el-col>
					</el-row>
					<el-row>
		...
		methods: {
			...
			submitForm(e) {
				this.$refs[e].validate((valid) => {
					if(valid) {
						...
						this.$post("/role/add", postData).then((res) => {
							let data = res;
							if(data.status_code == 0) {
								this.$message({
									type: 'success',
			...
			amendForm(e) {
				...
				this.$refs[e].validate((valid) => {
					if(valid) {
						...
						this.$post("/role/modify", postData).then((res) => {
							let data = res;
							if(data.status_code == 0) {
								this.$message({
									type: 'success',
			...
			muchDelete() {
				this.$delete("/role/delete", {
					role_id: this.multipleSelection.join(',')
				});
			},
			//单个删除
			deletes(e) {

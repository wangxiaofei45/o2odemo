	...
	<div>
						...
						<el-col :span="24">
							<el-form-item label="单据状态">
								<el-radio-group v-model="formInline.radio">
									...
									<el-radio :label="6">已付款</el-radio>
									<el-radio :label="9">已退货</el-radio>
								</el-radio-group>
							</el-form-item>
						</el-col>
					</el-row>
		...
		<div class="tab-container" v-show="addPuechseMan">
			...
			<div class="title">
				<el-row>
					<el-col :span="24">
						<el-button @click="openPutInStorage" type="primary">退单</el-button>
					</el-col>
				</el-row>
			</div>
			<!--调拨入库搜索框-->
					...
					<el-row>
						...
						<el-col :span="6">
							<el-form-item label="店铺">
								<el-select v-model="forMation.shop" placeholder="请选择">
						...
						<el-col :span="6">
							<el-form-item label="营业员">
								<el-select v-model="forMation.user" placeholder="请选择">
									<el-option label="区域一" value="1"></el-option>
									<el-option label="区域二" value="2"></el-option>
								</el-select>
							</el-form-item>
						...
						<el-col :span="6">
							<el-form-item label="摘要">
								<el-input v-model="forMation.user"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="6">

	...
	<div class="tab-container">
		<div v-if="showModel == 1">
			...
			<el-table :data="data" stripe border  style="width: 100%;" size="mini">
				...
				<el-table-column prop="document_num" width="200" label="单据号" align="center">
		...
		<div class="tab-container" v-show="showModel == 4">
			<el-row class="model_title">
				...
				<el-col :span="12" style="text-align: right;">
					<el-button type="text" @click="back" name="topRightCancel">
					...
					<el-row>
						...
						<el-col :span="6">
							<el-form-item label="制单人">
								<el-input v-model="forMation4.user_name" placeholder="" style="width:220px;" disabled></el-input>
							</el-form-item>
						</el-col>
					</el-row>
				</el-form>
		...
		<div class="tab-container" v-show="showModel == 5">
			<el-row class="model_title">
				<el-col :span="12" style="border-left: #13C2C2 3px solid; padding-left: 15px;">
					{{modelTitle}}单
				</el-col>
			...
			<div class="search1">
				<el-form label-width="80px" :inline="true" :model="forMation5" class="demo-form-inline">
					<el-row>
						<el-col :span="6">
							<el-form-item label="单据号">
								<el-input v-model="forMation5.document_num" placeholder="" style="width:220px;" disabled></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="6">
							<el-form-item label="日期">
								<el-date-picker v-model="forMation5.created_at" type="date" placeholder="选择日期" disabled>
								</el-date-picker>
							</el-form-item>
						</el-col>
						<el-col :span="6">
							<el-form-item label="会员" disabled>
								<el-input v-model="forMation5.name" placeholder="" style="width:220px;" disabled></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="6">
							<el-form-item label="摘要">
								<el-input v-model="forMation5.abstract" placeholder="" style="width:220px;" disabled></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="6">
							<el-form-item label="营业员" disabled>
								<el-input v-model="forMation5.sales_name" placeholder="" style="width:220px;" disabled></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="6">
							<el-form-item label="收银员" disabled>
								<el-input v-model="forMation5.user_name" placeholder="" style="width:220px;" disabled></el-input>
							</el-form-item>
						</el-col>
					</el-row>
				</el-form>
			...
			<!--展示的表格-->
			<div class="tTable">
				<el-table :data="newTableData5" stripe border style="width: 100%;" size="mini">
					<el-table-column type="index" label="序号" fixed width="50" align="center">
					</el-table-column>
				...
				switch(type) {
					...
					case 4:
						this.$post(this.$retailopenbillinfo, postData).then((res) => {
							if(res.status_code == 0) {
								this.showModel = 5;
								this.forMation5 = res.data;
								this.forMation5.name = res.data.memberInfo.name;
								this.newTableData5 = res.data.goodsData;
							} else {
								this.$message({
									type: 'error',
									message: res.message,

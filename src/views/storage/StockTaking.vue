		...
		<div class="tab-container" v-show="isShow == 1">
			<el-form label-width="80px" :inline="true" v-model="formInline" class="demo-form-inline">
				<div class="title" >
					<el-row>
						<el-col>
							<el-button v-show="permission.indexOf('136') != -1" type="primary" @click="addPurseMan">新增</el-button>
			...
			<div class="tTable" id="printMe">
				<el-table :data="data" stripe border style="width: 100%;" size="mini">
					...
					<el-table-column prop="status" label="审核状态" width="100" align="center">
						<template slot-scope="scope">
							<el-button v-if="scope.row.status == 0" type="text">未提交</el-button>
							<el-button v-if="scope.row.status == 1" type="text">已提交</el-button>
						</template>
					</el-table-column>
			...
			<div class="title">
				<el-row v-show="!disabled">
					<el-col :span="24">
						...
						<!--编辑时候的保存-->
						<el-button v-show="permission.indexOf('137') != -1" type="primary" @click="EditOutOrder"  v-if="showSave == 2">编辑保存</el-button>
						<!--查看的时候没有保存-->

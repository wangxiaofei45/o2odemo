						...
						<el-col :span="24">
							<el-form-item label="单据状态">
								<el-radio-group v-model="formInline.radio">
									...
									<el-radio :label="6">未结存</el-radio>
									<el-radio :label="9">已结存</el-radio>
								</el-radio-group>
							</el-form-item>
						</el-col>
					</el-row>
				...
				<el-table :data="data" stripe border style="width: 100%;" show-summary :summary-method="getSummaries" size="mini">
					...
					<el-table-column prop="documentNumber" label="单据号" fixed width="150" align="center">
						<template slot-scope="scope">
							<!--点击单据号跳转显示单据详情-->
							<p  style="cursor:pointer">{{scope.row.documentNumber}}</p>
						</template>
					</el-table-column>
			...
			<div class="title">
				<el-row>
					<el-col :span="24">
						...
						<el-button type="primary" @click="bePutInStorage">提交</el-button>
					</el-col>
				</el-row>
			</div>
			<!--调拨入库搜索框-->
...
<script>
	export default {
		data() {
			return {
				search: '', //采购单输入
				isShow: false, //采购单是否显示
				addPuechseMan: true, //新增采购单显示隐藏

						...
						<el-col :span="24">
							<el-form-item label="单据状态">
								<el-radio-group v-model="formInline.radio">
									...
									<el-radio :label="6">未出库</el-radio>
									<el-radio :label="9">已出库</el-radio>
								</el-radio-group>
							</el-form-item>
						</el-col>
					</el-row>
			...
			<div class="tTable"  id="printMe">
				<el-table :data="data" stripe border style="width: 100%;" show-summary :summary-method="getSummaries" size="mini">
					...
					<el-table-column label="操作" width="200" fixed="right" align="center">
						<template slot-scope="scope">
							<el-button size="mini" type="primary" @click="bePutInStorage(scope.row.role_id)">出库</el-button>
			...
			<div class="title">
				<el-row>
					<el-col :span="12">
						...
						<el-button type="primary" @click="bePutInStorage">确认出库</el-button>
					</el-col>
					<el-col :span="12" style='text-align: right;'>

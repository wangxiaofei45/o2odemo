	...
	<div>
		<div class="tab-container" v-show="isShow">
			<div class="title">
				<el-row>
					<el-col>
						<el-button @click="addPurseMan" type="primary">新增</el-button>
						...
						<el-col :span="24">
							<el-form-item label="单据状态">
								<el-radio-group v-model="formInline.radio">
									...
									<el-radio :label="6">已报溢</el-radio>
									<el-radio :label="9">未报溢</el-radio>
								</el-radio-group>
							</el-form-item>
						</el-col>
					</el-row>
			...
			<div class="tTable"  id="printMe">
				<el-table :data="data" stripe border style="width: 100%;" show-summary :summary-method="getSummaries" size="mini">
					...
					<el-table-column label="操作" width="200" fixed="right" align="center">
						<template slot-scope="scope">
							<el-button size="mini" type="primary" @click="bePutInStorage(scope.row.role_id)">结存</el-button>
							<el-button size="mini" type="danger" @click="deletes(scope.row.role_id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
			</div>
					...
					<el-row>
						...
						<el-col :span="6">
							<el-form-item label="盘点类型">
								<el-select v-model="forMation.shop" placeholder="选择">
		...
		<!--报溢单-->
		<div class="tab-container" v-show="Theoverflowofsingle">
			<!--title-->
			<el-row class="model_title">
				<el-col :span="12" style="border-left: #13C2C2 3px solid; padding-left: 15px;">
					报溢单
				...
				<el-col :span="12" style="text-align: right;">
					<el-button type="text" @click="closeTheoverflowofsingle">
						<svg-icon icon-class="cancel" />
					</el-button>
				</el-col>
			</el-row>
			<div class="title">
				<el-row>
					<el-col :span="24">
						...
						<el-button type="primary">确认报溢</el-button>
					</el-col>
				</el-row>
			</div>
			<!--调拨入库搜索框-->
	...
	export default {
		data() {
			return {
				...
				Theoverflowofsingle:false,//报溢单详情
		...
		methods: {
			...
			openTheoverflowofsingle(){
				this.isShow = false;
				this.Theoverflowofsingle = true;
			},
			closeTheoverflowofsingle(){
				this.Theoverflowofsingle = false;
				this.isShow = true;
			}
		}
	}

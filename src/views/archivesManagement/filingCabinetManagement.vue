				...
				<el-table :data="data" stripe border style="width: 100%;" size="mini">
					...
					<el-table-column label="操作" width="300" align="center">
						<template slot-scope="scope">
							<el-button @click="gotosee(scope.row)" type="primary" size="mini">查看档案盒</el-button>
					...
					<el-row>
						...
						<el-col :span="24">
							<el-form-item label="备注" prop="remark">
								<el-input type="textarea" placeholder="请输入" style="width: 300px;" v-model="accountFrom.remark"></el-input>
							</el-form-item>
						</el-col>
					</el-row>
					...
					<el-row>
						...
						<el-col :span="24">
							<el-form-item label="编号" prop="number">
								<el-input placeholder="请输入" v-model="amendInfo.number"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item label="名称" prop="nickName">
						...
						<el-col :span="24">
							<el-form-item label="备注" prop="remark">
								<el-input type="textarea" placeholder="请输入" style="width: 300px;" v-model="amendInfo.remark"></el-input>
							</el-form-item>
						</el-col>
					</el-row>

<template>
	<div class="container">
		<el-row>
			<el-radio-group v-model="type" @change="selectType" style="margin-bottom:15px">
				<el-radio style="margin-right: 30px;" :label="1">销售属性</el-radio>
		...
		<el-row>
			<el-col :span="8" style="border:1px solid #e6e6e6;">
				<el-row class="title">
					<el-col :span="8">
						<el-button v-show="permission.indexOf('181') != -1" type="text" style="padding:0px" :disabled="disabled1 == 1" @click="leval_1_add" v-if="button_1">
					...
					<el-col :span="8" style="text-align:right">
						<el-button v-show="permission.indexOf('183') != -1" type="text" style="padding:0px" :disabled="disabled1 == 1" @click="leval_1_del" v-if="button_delete1 == 1">
				...
				<el-row>
					<el-col :span="24">
						<el-table class="newTable" v-loading="listLoading" :data="list" row-key="id" fit highlight-current-row  height="500" style="width: 100%" @current-change="selectTable1">
							...
							<!--<el-table-column align="center" label="选择" v-if="button_delete1 == 1">
								<template slot-scope="scope" v-if="button_delete1 == 1">
									<el-select disabled v-model="scope.row.style" placeholder="请选择" size="mini" style="width:80px">
			...
			<el-col :span="8" style="border:1px solid #e6e6e6;">
				<el-row class="title">
					<el-col :span="8">
						<el-button v-show="permission.indexOf('185') != -1" type="text" style="padding:0px" :disabled="disabled2 == 1" @click="leval_2_add" v-if="button_2">
							<svg-icon icon-class="typeAdd" style="margin-right: 10px;" />
						</el-button>
					...
					<el-col :span="8" style="text-align:right">
						<el-button v-show="permission.indexOf('187') != -1" type="text" style="padding:0px" :disabled="disabled2 == 1" @click="leval_2_del" v-if="button_delete2 == 1">
							<svg-icon icon-class="typejian" style="margin-right: 10px;" />
						</el-button>
				...
				<el-row>
					<el-col id="table2" :span="24">
						<el-table class="newTable" v-loading="listLoading" :data="list2" row-key="id" fit highlight-current-row height="500" style="width: 100%" @current-change="selectTable2">
			...
			<el-col :span="8" style="border:1px solid #e6e6e6;">
				...
				<el-row>
					<el-col id="table3" :span="24">
						<el-table class="newTable" v-loading="listLoading" :data="list3" row-key="id" fit highlight-current-row height="500" style="width: 100%">
							...
							<el-table-column align="center" label="删除" width="65" v-if="button_delete3 == 0">
								<template slot-scope="scope" v-if="button_delete3 == 0">
									<el-button type="text" size="mini" @click="delete3(scope.row.id)" style="padding:0px !important">
										<svg-icon icon-class="icon_reduce" />
									</el-button>
								</template>
							</el-table-column>

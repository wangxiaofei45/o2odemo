...
<template>
	<div class="tab-container">
		<div class="title">
			<el-row>
				<el-col :span="24">
					<el-button v-show="permission.indexOf('190') != -1" type="primary" @click="addMember"><svg-icon icon-class="add" style="margin-right: 10px;" />新增</el-button>
				</el-col>
			</el-row>
		</div>
		<div class="tTable">
			<el-table :data="data" stripe border style="width: 100%;" size="mini">
				...
				<el-table-column prop="disabled" label="是否显示" align="center">
					<template slot-scope="scope">
							<span v-if="permission.indexOf('192') != -1">
								<el-button v-if="scope.row.disabled == 0" @click="SiteMember(scope.row)" type="text" size="mini">是</el-button>
								<el-button v-if="scope.row.disabled == 1" @click="SiteMember(scope.row)" type="text" size="mini" style="color: #666;">否</el-button>
							</span>
							<span v-else>
				...
				<el-table-column label="操作" width="250" fixed="right" align="center">
					<template slot-scope="scope">
						<el-button v-show="permission.indexOf('192') != -1" size="mini" type="primary" @click="amendMember(scope.row)">编辑</el-button>
						<el-button v-show="permission.indexOf('193') != -1" size="mini" type="danger" @click="deletes(scope.row.brand_id)">删除</el-button>
					</template>
				</el-table-column>
			</el-table>
		</div>
			...
			<div class="model_con">
				<el-row class="model_title">
					...
					<el-col :span="12" style="text-align: right;">
						<el-button type="text" @click="cancel_newInfo('form')" name="topRightCancel">
				...
				<el-form :model="form" :rules="form_rule" ref="form" label-width="100px">
					<el-row>
						<el-col :span="12">
							<el-form-item label="品牌名称" prop="brand_name">
								<el-input placeholder="请输入" v-model="form.brand_name" @blur='getPinYinFirstCharacter' style="width: 300px;"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="品牌首字母" prop="brand_initial">
								<el-input v-model="form.brand_initial" style="width: 300px;color: #333333;" disabled></el-input>
							</el-form-item>
						</el-col>

						<el-col :span="12">
							<el-form-item label="商品分类" prop="class_id">
								<el-select v-model="form.class_id" placeholder="请选择" style="width: 300px;">
						...
						<el-col :span="24">
							<el-form-item label="详情介绍" prop="brand_introduction">
								<el-input placeholder="请输入" style="width: 760px;" v-model="form.brand_introduction"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item label="官方网址" prop="brand_official_web">
								<el-input placeholder="请输入" style="width: 760px;" v-model="form.brand_official_web"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item label="公司名称" prop="shop_name">
								<el-input placeholder="请输入" style="width: 760px;" v-model="form.bankcode"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="品牌logo" prop="brand_pic">
								...
								<el-upload class="avatar-uploader" :multiple="true" action="http://up.qiniu.com/" accept="image/jpeg,image/gif,image/png,image/bmp" :data="postData" :show-file-list="false" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload">
									...
									<div class="upload_img" v-else>
										<img class="default" src="../../../static/img/addImg.png"/>
									</div>
								</el-upload>
							</el-form-item>
						</el-col>
					...
					<el-row style="text-align: center;">
						<el-col :span="24" class="bottomButton">
							<el-button @click="cancel_newInfo('form')" name="cancel">取消</el-button>
		...
		<div class="model" v-show="amend_info_model">
			<div class="model_con">
				<el-row class="model_title">
					...
					<el-col :span="12" style="text-align: right;">
						<el-button type="text" @click="cancelAmendInfo" name="topRightCancel">
							<svg-icon icon-class="cancel" />
						</el-button>
					</el-col>
				</el-row>
				<el-form :model="amendForm" :rules="amendFormRule" ref="amendForm" label-width="100px">
					<el-row>
						<el-col :span="12">
							<el-form-item label="品牌名称" prop="brand_name">
								<el-input style="width: 300px;" v-model="amendForm.brand_name"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="品牌首字母" prop="brand_initial">
								<el-input style="width: 300px; color: #333333;" v-model="amendForm.brand_initial" disabled></el-input>
							</el-form-item>
						</el-col>

						<el-col :span="12">
							<el-form-item label="商品分类" prop="class_id">
								<el-select  style="width: 300px;" v-model="amendForm.class_id" placeholder="请选择">
									<el-option v-for="item in goodClass" :key="item.id" :label="item.name" :value="item.id"></el-option>
								</el-select>
							</el-form-item>
						</el-col>
						...
						<el-col :span="24">
							<el-form-item label="详情介绍" prop="brand_introduction">
								<el-input  style="width: 760px;" v-model="amendForm.brand_introduction"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item label="官方网址" prop="brand_official_web">
								<el-input style="width: 760px;" v-model="amendForm.brand_official_web"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item label="公司名称" prop="shop_name">
								<el-input style="width: 760px;" v-model="amendForm.bankcode"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="品牌logo" prop="brand_pic">
								<el-input v-model="amendForm.brand_pic" v-show="false"></el-input>
								<el-upload class="avatar-uploader" :multiple="true" action="http://up.qiniu.com/" accept="image/jpeg,image/gif,image/png,image/bmp" :data="postData" :show-file-list="false" :on-success="handleAvatarSuccess2" :before-upload="beforeAvatarUpload">
									<div class="upload_img" v-if="imageUrl_2">
					...
					<el-row style="text-align: center;" class="bottomButton">
						<el-button @click="cancelAmendInfo" name="cancel">取消</el-button>
		...
		methods: {
			...
			arraySearch(str) {
				for(var name in this.PinYin) {
					if(this.PinYin[name].indexOf(str) != -1) {
						return name;
						break;
					}
				}
			...
			getPinYinFirstCharacter(str, split, uppercase) {
				split = split || " ";
				uppercase = true;
				var len = this.form.brand_name.length;
				var result = "";
				var reg = new RegExp('[a-zA-Z0-9\- ]');
				var val;
				var name;
				for(var i = 0; i < len; i++) {
					val = this.form.brand_name.substr(i, 1);
				...
				if(uppercase) result = result.toUpperCase();
				result = result.replace(split, "");
				let newstr = result.substr(0,1);
				this.form.brand_initial = newstr;
//				return result.trim();
			},
			ajaxjson() {
				let postData = {
			...
			handleAvatarSuccess2(res, file) {
				this.imageUrl_2 = URL.createObjectURL(file.raw) //暂时展示 的还是本地添加图片
				this.amendForm.brand_pic = res.key //本地地址上传展示
			},
			// 全选
			SelectionChange(val) {
				let arrays = [];
					...
					if(data.status_code == 0) {
						...
						this.$post(this.$goodsbrandInfo, postDatas).then((res) => {
							...
							if(data.status_code == 0) {
								...
								this.imageUrl_2 = data.data.domain+ data.data.brand_pic;
							} else {

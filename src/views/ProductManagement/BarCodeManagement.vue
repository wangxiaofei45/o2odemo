	...
	export default {
		...
		methods: {
			...
			ajaxjson() {
				...
				//调用post请求方法
				this.$post(this.$RoleList, postData).then((res) => {
					let data = res;
			...
			submitForm(e) {
				this.$refs[e].validate((valid) => {
					if(valid) {
						...
						this.$post(this.$RoleAdd, postData).then((res) => {
							let data = res;
							if(data.status_code == 0) {
								this.$message({
									type: 'success',
			...
			amendForm(e) {
				this.$refs[e].validate((valid) => {
					if(valid) {
						...
						this.$post(this.$RoleModify, postData).then((res) => {
							let data = res;
							if(data.status_code == 0) {
								this.$message({
									type: 'success',

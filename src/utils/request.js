...
Vue.prototype.$staticGetBillingUser = Util.apiUrl + "static/getBillingUser"; // 获取制单人列表
Vue.prototype.$staticUserlist = Util.apiUrl + "static/userlist"; // 获取会员的列表

//登录信息 完善
Vue.prototype.$userOrgInfo = Util.apiUrl + "user/orgInfo"; // 获取信息
Vue.prototype.$userOrgInfoUpdate = Util.apiUrl + "user/orgInfoUpdate"; // 获取信息
Vue.prototype.$commonSend = Util.apiUrl + "common/send"; // 获取验证码
Vue.prototype.$commonResetPassword = Util.apiUrl + "common/resetPassword"; //修改密码
//首页
...
Vue.prototype.$organizationInfo = Util.apiUrl + "organization/info"; //获取信息
Vue.prototype.$organizationModify = Util.apiUrl + "organization/modify"; //更新信息
...
Vue.prototype.$goodsclassAdd = Util.apiUrl + "goodsclass/add"; //商品分类 添加
...
Vue.prototype.$customerAdd = Util.apiUrl + "customer/add"; //添加商家
Vue.prototype.$customerAddShop = Util.apiUrl + "customer/addShop"; //添加店铺
Vue.prototype.$customerDel = Util.apiUrl + "customer/del"; //
Vue.prototype.$customerEdit = Util.apiUrl + "customer/edit"; //平台编辑商家
// 基础设置
...
Vue.prototype.$archivesEditCompany = Util.apiUrl + "archives/editCompany"; //公司档案编辑
...
Vue.prototype.$memberMemberRechargeList = Util.apiUrl + "member/memberRechargeList"; //会员充值记录
...
Vue.prototype.$goodsImport = Util.apiUrl + "goods/import"; // 商品注册 导入
Vue.prototype.$goodsExport = Util.apiUrl + "goods/export"; // 商品注册 导出列表
//商品管理 添加
...
Vue.prototype.$storageEditOrder = Util.apiUrl + "storage/editOrder"; // 仓库管理  编辑
...
Vue.prototype.$transferEditOutOrder = Util.apiUrl + "transfer/editOutOrder"; // 仓库管理 调拨出库编辑
...
Vue.prototype.$retailopenbillDelete = Util.apiUrl + "retailopenbill/delete"; //销售订单 删除
...
Vue.prototype.$cashHandoverDxportSaleInfo = Util.apiUrl + "cashHandover/exportSaleInfo"; // 销售管理 接班导出
...
//Date.parse(postData.birth_time)/1000;格式化时间为时间戳格式
//获取当前时间
